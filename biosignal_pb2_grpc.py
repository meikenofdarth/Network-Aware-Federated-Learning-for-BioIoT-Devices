...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in biosignal_pb2_grpc.py depends on'
...
class BioNetServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendSignal = channel.unary_unary(
                '/biosignal.BioNetService/SendSignal',
...
def add_BioNetServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('biosignal.BioNetService', rpc_method_handlers)
